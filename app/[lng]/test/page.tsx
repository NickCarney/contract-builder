...
const Test = () => {
  ...
  useEffect(() => {
    const fetchEmails = async () => {
      const response = await fetch('https://contract-builder-git-proagent-mesa.vercel.app/en/api/auth/messages');
  ...
  const fetchEmailDetails = async (id: string) => {
    const response = await fetch(`https://contract-builder-git-proagent-mesa.vercel.app/en/api/auth/${id}`);
    const data = await response.json();
